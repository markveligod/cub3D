...
SRC_UTILS = ./utils/ft_atoi.c ./utils/ft_putstr_fd.c ./utils/ft_strjoin.c ./utils/ft_strlen.c ./utils/get_next_line.c ./utils/ft_strlcpy.c ./utils/ft_split.c ./utils/ft_bzero.c ./utils/ft_strtrim.c
...
SRC_GAME = ./engine/game/game.c ./engine/game/init_game_struct.c ./engine/game/game_control_keys.c
